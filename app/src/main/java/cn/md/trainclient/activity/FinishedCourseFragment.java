...
import cn.md.trainclient.adapter.FinishedCourseAdapter;
 ...
 * Date: 2015-07-10.
 */
public class FinishedCourseFragment extends BaseFragmnet {

    private SwipeRefreshLayout mRefreshLayout;

    public static FinishedCourseFragment newInstance() {
        FinishedCourseFragment fragment = new FinishedCourseFragment();
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FinishedCourseAdapter adapter = new FinishedCourseAdapter(getActivity(), getDummyData());
